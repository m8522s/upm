...
UPM can complete routine tasks like `install`, `update`, `remove`, and `search`. For complex tasks, like "which package depends on this file", call the package manager directly.

UPM is validated on CentOS 7, Debian 10, OpenWrt 19.07, OpenWrt 25.10, and OPNsense 20.1. Support is planned for Ubuntu, FreeBSD, SuSE.
